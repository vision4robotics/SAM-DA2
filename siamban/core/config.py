...
__C.TRAIN.BASE_LR_b = 0.005  # the learning rate for mamba bridging layer
...
__C.DATASET.NAT = CN()
__C.DATASET.NAT.ROOT = '/mnt/sdf/SAM-DA/NAT2021/seg/NAT2021-seg/crop511'         #'./train_dataset/sam_nat/crop511'
__C.DATASET.NAT.ANNO = '/mnt/sdf/SAM-DA/NAT2021/seg/NAT2021-seg/json/sam_nat_b.json'  #'./train_dataset/sam_nat/sam_nat_b.json'
__C.DATASET.NAT.ANNO_B ='/mnt/sdf/SAM-DA/NAT2021/seg/NAT2021-seg/json/sam_nat_b.json' #'./train_dataset/sam_nat/sam_nat_b.json'
__C.DATASET.NAT.ANNO_S ='/mnt/sdf/SAM-DA/NAT2021/seg/NAT2021-seg/json_nat_s.json' #'./train_dataset/sam_nat/sam_nat_s.json'
__C.DATASET.NAT.ANNO_T ='/mnt/sdf/SAM-DA/NAT2021/seg/NAT2021-seg/json/sam_nat_t.json' #'./train_dataset/sam_nat/sam_nat_t.json'
__C.DATASET.NAT.ANNO_N ='/mnt/sdf/SAM-DA/NAT2021/seg/NAT2021-seg/json/sam_nat_n.json' #'./train_dataset/sam_nat/sam_nat_n.json'
...
__C.HP_SEARCH.UAV123 = [0.473, 0.02, 0.385]
...
__C.HP_SEARCH.UAVDark135 = [0.473, 0.02, 0.385]

__C.HP_SEARCH.DarkTrack2021 = [0.473, 0.02, 0.385]


__C.HP_SEARCH.NUT_L = [0.473, 0.02, 0.385]
__C.HP_SEARCH.NAT2024_1 = [0.473, 0.02, 0.385]
__C.HP_SEARCH.NAT2024_2 = [0.473, 0.02, 0.385]