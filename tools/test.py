...
parser.add_argument('--dataset', type=str,default='UAVDark135',
        help='datasets')
parser.add_argument('--dataset_root', default='/mnt/sdb/Test_dataset/', type=str,      
        help='dataset root path')
parser.add_argument('--config', default=os.getcwd() + '/experiments/sam-mamba-da/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='sam-mamba-da-track', type=str,        
        help='snapshot of models to eval')
parser.add_argument('--snapshot_path', default='./snapshot/', type=str,        
...
def main():
    ...
    model_name = f'{args.snapshot}' + '_'+ str(hp['lr']) + '_' + str(hp['penalty_k']) + '_' + str(hp['window_lr'])
